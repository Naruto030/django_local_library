...
class Genre(models.Model):
    ...
    name = models.CharField(max_length=200, help_text="Вставте жанр книги")
...
class BookInstance(models.Model):
    ...
    status = models.CharField(max_length=1, choices=LOAN_STATUS, blank=True, default='m', help_text='забранировать наличие')
