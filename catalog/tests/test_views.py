...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        return_date= datetime.date.today() + datetime.timedelta(days=5)
        self.test_bookinstance1=BookInstance.objects.create(book=test_book,imprint='Unlikely Imprint, 2016', due_back=return_date, borrower=test_user2, status='o')
    ...
    def test_redirect_if_logged_in_but_not_correct_permission(self):
        ...
        resp = self.client.get(reverse('renew-book-librarian', kwargs={'pk':self.test_bookinstance1.pk,}))
        self.assertEqual(resp.status_code,302)
        self.assertEqual(resp.url.startswith('/accounts/login/'))
    ...
    def test_form_renewal_date_initially_has_date_three_weeks_in_future(self):
        ...
        self.assertEqual(resp.context['form'].initial['renewal-date'], date_3_weeks_in_future)
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertEqual(resp.status_code,200)
        self.assertFormError(resp, 'form', 'renewal_date', 'Invalid date - renewal -n past')
